...
class Program
{
    public static void Main(string[] args)
    {
        ...
        do      // Aca utilizamos un Do while, es decir, va ejecutar todo y al final va comprobar si la condicion es verdadera
        {
            Console.WriteLine();
            ...
            switch (opcion)         // Utilizamos switch ya que nos permite facilitar el menu de opciones
            {
                case 1:
                    ...
                    {
                        if (c.Dni == dni)       // Si C.Dni es igual a dni (lo que ingreso el usuario) se ejecuta
                        {
                            cliente = c;
                            break;
                        }
                    ...
                    if (cliente == null)        // Si clientes es igual a vacio crea uno nuevo
                    {
                        Console.WriteLine();
                        Console.WriteLine("Usted es un cliente nuevo, debe ingresar los datos de su cuenta");
                        Console.WriteLine();
                        ...
                        {
                            Console.WriteLine();
                            Console.WriteLine("No se pudo agregar la cuenta, volviendo.");
                            break;
                        }
                    ...
                    // Devuelve la lista de todas las cuentas del banco, busca el mayor número de cuenta existente y genera el siguiente número disponible, así no se repite
                ...
                case 2:
                    ...
                    //Si encuentra una cuenta cuyo número (c.Numero) coincide con el ingresado (numero), la guarda en la variable cuenta.
                    ...
                    {
                        banco.EliminarCuenta(cuenta);       // Llamada al metodo para que elimine la cuenta

                        // Tiene mas de una cuenta
                ...
                case 3:
                    ...
                    // Obtiene clientes con mas de una cuenta 
                ...
                case 7:
                    ...
                    if (banco.ListaCuentas.Count == 0)
                    {
                        Console.WriteLine("No hay cuentas actualmente");
                    }
                ...
                case 8:
                    ...
                    {
                        Console.WriteLine("No hay clientes actualmente");
                    }
...
public class TelefonoInvalidoExcepcion : Exception
{
